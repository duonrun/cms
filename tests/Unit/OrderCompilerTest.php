...
{
	private function compiler(array $builtins = []): OrderCompiler
	{
		return new OrderCompiler(SqlDialectFactory::fromDriver('pgsql'), $builtins);
	}
	...
	{
		$oc = $this->compiler(['field' => 'n.field']);
	...
	{
		$oc = $this->compiler(['field' => 'n.field', 'column' => 'uc.column']);
		$s = ",\n    ";
	...
	public function testFailOnInjection1(): void
	{
		...
		$this->compiler()->compile('; DROP TABLE students;');
	}
	...
	public function testFailInvalidField1(): void
	{
		...
		$this->compiler()->compile('field.to.');
	}
	...
	public function testFailInvalidField5(): void
	{
		...
		$this->compiler()->compile('field.to. DESC');
	}
	...
	public function testFailMultipleCommas(): void
	{
		...
		$this->compiler()->compile('field1,,field2');
	}
}
